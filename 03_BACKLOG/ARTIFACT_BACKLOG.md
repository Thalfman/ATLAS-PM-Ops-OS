...
| ID | Artifact | Category | Phase | Priority | Purpose | Intended user | Data sensitivity posture | Target environment assumption | Human review point | Status | Notes and dependencies |
|---|---|---|---:|---|---|---|---|---|---|---|---|
| A-0025 | Employer Migration Plan | Employer migration | 11 | P3 | Convert local artifacts into approved workplace workflows after validation. | Tom; manager; IT and security contacts. | Tom-personal (plan only) | Markdown-local | Approval required per artifact before migration. | Ready for personal use | Lives at `11_MIGRATION/EMPLOYER_MIGRATION_PLAN.md`. Personal-preparation plan describing the discipline; does not pre-authorize any tool, data category, or artifact. Migration always gated on explicit employer approval. |
| A-0060 | Per-Artifact Migration Readiness Checklist | Employer migration | 11 | P3 | A short checklist applied to each ATLAS artifact before migration. | Tom. | Tom-personal (checklist only) | Markdown-local | Tom signs off per artifact; relevant employer approver signs off in writing. | Ready for personal use | Lives at `11_MIGRATION/PER_ARTIFACT_MIGRATION_READINESS_CHECKLIST.md`. Seven gates (approval, owner and review, scope and data, pilot, steady-state readiness, rollback, final go/no-go). A "no" or "unclear" at any gate is a hard stop. |
| A-0061 | Migration Rollback Note | Employer migration | 11 | P3 | Capture rollback steps for any migrated artifact. | Tom. | Tom-personal (template only) | Markdown-local | Tom and accountable employer owner approve. | Ready for personal use | Lives at `11_MIGRATION/MIGRATION_ROLLBACK_NOTE.md`. Eight-section template; reversibility tested at pilot, not just described. |

### Final review and maintenance

| ID | Artifact | Category | Phase | Priority | Purpose | Intended user | Data sensitivity posture | Target environment assumption | Human review point | Status | Notes and dependencies |
|---|---|---|---:|---|---|---|---|---|---|---|---|
| A-0062 | Final Operating System Review | Final review and maintenance | 12 | P3 | End-to-end review of ATLAS against safety boundary, value proposition, and migration readiness. | Tom. | Tom-personal | Markdown-local | Tom signs off before resetting operating rhythm. | Ready for personal use | Lives at `12_FINAL_REVIEW/FINAL_OPERATING_SYSTEM_REVIEW.md`. Inventory of 13 phases; verification against safety boundary, value proposition, migration readiness. Verdict: build-complete at personal-preparation level. |
| A-0063 | Gap List | Final review and maintenance | 12 | P3 | Capture what is missing, weak, or stale across the operating system. | Tom. | Tom-personal | Markdown-local | Tom prioritizes gaps before next operating cycle. | Ready for personal use | Lives at `12_FINAL_REVIEW/GAP_LIST.md`. Open items: A-0038 W-16, A-0029 skill files, pack-index reconciliation for Phase 9 demos. Coverage gaps and posture gaps are non-blocking. |
| A-0064 | Operating Rhythm | Final review and maintenance | 12 | P3 | Define the steady-state cadence for using and maintaining ATLAS. | Tom. | Tom-personal | Markdown-local | Tom commits to the cadence; revisits monthly. | Ready for personal use | Lives at `12_FINAL_REVIEW/OPERATING_RHYTHM.md`. Daily, weekly, monthly, quarterly, annual cadences plus on-trigger actions. |
| A-0065 | Maintenance Plan | Final review and maintenance | 12 | P3 | Define how ATLAS gets refreshed, retired, or migrated over time. | Tom. | Tom-personal | Markdown-local | Tom owns the plan; revisits at major transitions. | Ready for personal use | Lives at `12_FINAL_REVIEW/MAINTENANCE_PLAN.md`. Routine vs trigger-based refresh; retirement discipline; what gets added (sparingly); when to declare ATLAS retired. |

## Current build recommendation

**All 13 phases (Phase 0 through Phase 12) are complete.** ATLAS PM/Ops OS is build-complete at the personal-preparation level. Phase 12 (Final Operating System Review) is `Ready for personal use` for all four backlog rows: A-0062 Final Operating System Review (`12_FINAL_REVIEW/FINAL_OPERATING_SYSTEM_REVIEW.md`), A-0063 Gap List (`12_FINAL_REVIEW/GAP_LIST.md`), A-0064 Operating Rhythm (`12_FINAL_REVIEW/OPERATING_RHYTHM.md`), and A-0065 Maintenance Plan (`12_FINAL_REVIEW/MAINTENANCE_PLAN.md`). Phase 12 introduces the new top-level `12_FINAL_REVIEW/` directory.

ATLAS is now in **maintenance mode** (D-0062). Build sessions are exceptions, not the norm. Ongoing operation runs against the cadences in `OPERATING_RHYTHM.md` (daily / weekly / monthly / quarterly / annual). Open housekeeping items that do **not** block "all phases complete":

- A-0038 Process Gap Note Workflow (W-16 reserved) — pairs naturally with `LISTENING_PLAN.md`; pick up as a `chore/<slug>` session.
- A-0029 Local skill files refresh (`skills/*/SKILL.md`) — re-check against the now-stable Phase 4 / 5 / 6 / 7 / 8 / 9 / 10 schemas.
- Phase 7 demo pack index reconciliation to include Phase 9 EVM / accounting demos — minor index update.

These items are tracked in `12_FINAL_REVIEW/GAP_LIST.md`. New backlog rows beyond Phase 12 are append-only (D-0017) and should follow the maintenance discipline in `MAINTENANCE_PLAN.md`.
